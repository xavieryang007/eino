...
func queryUserCompany(_ context.Context, req *userCompanyRequest) (resp *userCompanyResponse, err error) {
...
func queryUserSalary(_ context.Context, req *userSalaryRequest) (resp *schema.StreamReader[*userSalaryResponse], err error) {
...
func (m *mockIntentChatModel) BindTools(_ []*schema.ToolInfo) error {
	return nil
}

func (m *mockIntentChatModel) Generate(_ context.Context, _ []*schema.Message, _ ...model.Option) (*schema.Message, error) {
...
func (m *mockIntentChatModel) Stream(_ context.Context, _ []*schema.Message, _ ...model.Option) (*schema.StreamReader[*schema.Message], error) {
	sr, sw := schema.Pipe[*schema.Message](2)
	sw.Send(&schema.Message{
		Role:    schema.Assistant,
		Content: "",
...
func TestToolsNodeOptions(t *testing.T) {
	...
	t.Run("tool_option", func(t *testing.T) {
		...
		msgs, err := internal.ConcatMessageArray(outMessages)
		assert.NoError(t, err)
...
func (m *mockTool) InvokableRun(_ context.Context, argumentsInJSON string, opts ...tool.Option) (string, error) {
...
func (m *mockTool) StreamableRun(_ context.Context, argumentsInJSON string, opts ...tool.Option) (*schema.StreamReader[string], error) {
